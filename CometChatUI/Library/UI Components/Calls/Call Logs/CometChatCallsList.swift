...
open class CometChatCallsList: UIViewController {
    ...
    /**
     This method register 'CometChatCallListItem' cell in tableView.
     - Author: CometChat Team
     - Copyright:  ©  2020 CometChat Inc.
     - See Also:
    ...
    private func registerCells(){
        let CometChatCallListItem  = UINib.init(nibName: "CometChatCallListItem", bundle: UIKitSettings.bundle)
        self.tableView.register(CometChatCallListItem, forCellReuseIdentifier: "CometChatCallListItem")
    }
