...
public struct UIKitSettings {
    ...
    // style
    static var primaryColor: UIColor = UIColor(red: 108/255, green: 51/255, blue: 154/255, alpha: 1) // #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
